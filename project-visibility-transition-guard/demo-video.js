...
<head>
  <meta charset="utf-8">
  <title>Project visibility transition guard demo</title>
  <style>
...
<body>
  ...
  <script>
    ...
    const checks = [
      ["Object permissions", "Public transitions downgrade or block edit and download grants."],
      ["Sensitive labels", "Restricted data and anonymous-review comments stay out of public releases."],
      ["Consent and holds", "Collaborator approvals, IRB holds, and funder embargoes gate visibility."],
      ["Audit evidence", "Requester, approver, object review, and final decision events are required."]
    ];
    ...
    function draw(frame) {
      ...
      ctx.fillText("Project Visibility Transition Guard", 48, 64);
      ctx.font = "19px Arial";
      ctx.fillStyle = "#475569";
      ctx.fillText("SCIBASE #11 workspace public-release governance demo", 48, 98);
      ...
      checks.forEach(([title, text], index) => {
        ...
        ctx.strokeStyle = active ? "#7c3aed" : "#cbd5e1";
        ctx.lineWidth = active ? 3 : 1;
        roundRect(48, y, 864, 54, 8);
        ctx.fill();
        ctx.stroke();
        ctx.fillStyle = active ? "#6d28d9" : "#64748b";
      ...
      ctx.font = "15px Arial";
      ctx.fillText("Synthetic data only. No OAuth, SAML, ORCID, storage, profile, permission, email, or audit-log network calls.", 48, 504);
    }
